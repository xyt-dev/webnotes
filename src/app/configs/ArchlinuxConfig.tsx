...
export default function ArchLinuxConfig() {
  return (
    <div className="prose daisy-prose max-w-[1500px] leading-[35px] p-6">
      ...
      <p className="whitespace-pre-line">
        ...
        {`
          重启后无法检测蓝牙设备:
          1. lsusb 检查蓝牙设备是否存在, 如不存在尝试断电长按开机键恢复设备状态.
          2. 检查 rfkill 确保蓝牙设备为 unblock.
          3. 以上均正常则可能是蓝牙设备驱动模块未加载: sudo modprobe -r btusb && sudo modprobe btusb.
        `}
      </p>
    </div>
  )
